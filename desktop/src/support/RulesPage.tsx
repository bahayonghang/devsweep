...
export function RulesPage({ bridge, locale }: RulesPageProps) {
  ...
  return <section className="support-page" aria-labelledby="rules-title">
    <h1 id="rules-title">{message(locale, "shell.v1.supporting.rules")}</h1>
    ...
    {selected && <article aria-labelledby="rule-detail-title">
