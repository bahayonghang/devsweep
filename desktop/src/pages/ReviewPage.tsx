...
export function ReviewPage(props: { state: AppState; onSelect: (id: string, selected: boolean) => void; onSelectAll: (selected: boolean) => void; onDryRun: () => void }) {
  ...
  return <section className="workspace">
    ...
    <TargetTable targets={targets} selectedIds={props.state.selectedIds} allSelected={allExecutableSelected(props.state)} disabled={busy} onSelect={props.onSelect} onSelectAll={props.onSelectAll} />
