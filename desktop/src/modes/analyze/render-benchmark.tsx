...
function benchmarkBridge(snapshot: AnalyzeSnapshotV1): DesktopBridge {
  return {
    ...
    softwareUpdatesCheck: async () => { throw new Error("unused benchmark bridge method"); },
    softwareStartupList: async () => { throw new Error("unused benchmark bridge method"); },
    softwareStartupSet: async () => { throw new Error("unused benchmark bridge method"); },
    softwareLeftoversPreview: async () => { throw new Error("unused benchmark bridge method"); },
    softwareLeftoversExecute: async () => { throw new Error("unused benchmark bridge method"); },
    optimizeListStart: async () => { throw new Error("unused benchmark bridge method"); },
    optimizePreview: async () => { throw new Error("unused benchmark bridge method"); },
    optimizeRun: async () => { throw new Error("unused benchmark bridge method"); },
    optimizeAudit: async () => { throw new Error("unused benchmark bridge method"); },
    optimizeCancel: async () => undefined,
    statusSnapshot: async () => { throw new Error("unused benchmark bridge method"); },
    statusLiveStart: async () => { throw new Error("unused benchmark bridge method"); },
    statusCancel: async () => undefined,
    analyzeStart: async (operationId) => ({ type: "completed", operation_id: operationId, snapshot }),
    analyzeCancel: async () => undefined,
    analyzeDefaultRoot: async () => { throw new Error("unused benchmark bridge method"); },
    analyzeReveal: async () => { throw new Error("unused benchmark bridge method"); },
    analyzeTrashPreview: async () => { throw new Error("unused benchmark bridge method"); },
    analyzeTrashExecute: async () => { throw new Error("unused benchmark bridge method"); },
